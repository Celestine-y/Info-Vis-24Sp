    ...
    */
    ...
    return (<Container>
        <Row>
            <p></p>
            <p></p>
            <h1 style = {{fontFamily: "cursive, 'Comic Sans MS', Georgia, serif, sans-serif", fontWeight: 'bold', textAlign: 'center', color:"#000080"}}>Salary Determinant Visualization</h1>
            <p></p>
        ...
        <Row className="mt-3">
            <h2 style = {{fontFamily: "cursive, 'Comic Sans MS', Georgia, serif, sans-serif", fontWeight: 'bold', color:"#000080"}}>A visualization on the salary dataset</h2>
        ...
        <Row>
            <h2 style = {{fontFamily: "cursive, 'Comic Sans MS', Georgia, serif, sans-serif", fontWeight: 'bold', color:"#000080"}}> Barcharts: the relation between Education/Race and Salary</h2>
        ...
        <Row>
            <h2 style = {{fontFamily: "cursive, 'Comic Sans MS', Georgia, serif, sans-serif", fontWeight: 'bold', color:"#000080"}}>A scatter plot: the relation between Age and Salary & A treemap with recursive subdivision</h2>
